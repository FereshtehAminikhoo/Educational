            ...
            <div class="table__box">
                <table class="table">
                    ...
                    <tr role="row" class="">
                        ...
                        <td>
                        @if ($course->banner)
                            <img src="{{$course->banner->thumb}}" alt="" width="80">
                        @else
                            <span>-</span>
                        @endif
                        </td>
                        ...
                        <td>
                            @can(\RolePermissions\Models\Permission::PERMISSION_MANAGE_COURSES)
                                ...
                                <a href="" onclick="updateConfirmationStatus(event, '{{route('courses.lock', $course->id)}}', 'آیا از قفل کردن این آیتم اطمینان دارید؟', 'قفل شده', 'status')" class="item-lock mlg-15" title="قفل کردن"></a>
                            @endcan
