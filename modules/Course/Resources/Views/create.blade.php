    ...
    <div class="row no-gutters ">
        <div class="col-12 bg-white">
            ...
            <form action="{{route('courses.store')}}" method="post" class="padding-30" enctype="multipart/form-data">
                @csrf
                <x-input type="text" name="title" placeholder="عنوان دوره" required></x-input>

                <x-input type="text" name="slug" class="text-left" placeholder="نام انگلیسی دوره" required></x-input>

                <div class="d-flex multi-text">
                    <x-input type="text" name="priority" class="text-left" placeholder="ردیف دوره"></x-input>

                    <x-input type="text" name="price" placeholder="مبلغ دوره" class="text-left" required></x-input>

                    <x-input type="number" name="percent" placeholder="درصد مدرس" class="text-left" required></x-input>
                </div>
                ...
                <x-file-upload type="file" name="image" placeholder="آپلود بنر دوره" required></x-file-upload>
